...
const createMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // 🔔 NOTIFICATION
        yield (0, notificationHelper_1.triggerNotification)('business', 'New Team Member Added', `${member.name} (${member.role}) has joined the team.`, '/admin/staff');
...
const updateMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // 🔔 NOTIFICATION
        yield (0, notificationHelper_1.triggerNotification)('business', 'Team Member Updated', `${member.name}'s profile has been updated.`, '/admin/staff');
...
const deleteMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const member = yield Team_1.default.findById(req.params.id);
        if (!member)
            return res.status(404).json({ message: 'Member not found' });
        const name = member.name;
        yield Team_1.default.findByIdAndDelete(req.params.id);
        // 🔔 NOTIFICATION
        yield (0, notificationHelper_1.triggerNotification)('business', 'Team Member Removed', `${name} has been removed from the team.`, '/admin/staff');
